...
def train_model(X_train, y_train, out_dir):
    """Train a Multi-Layer Perceptron Regressor (Neural Network) with 5-Fold CV."""
    ...
    joblib.dump(search.best_estimator_, f"{out_dir}/MLPRegress_best.joblib")
    ...
    with open(f"{out_dir}/MLP_Regression_cv.json", "w") as f:
