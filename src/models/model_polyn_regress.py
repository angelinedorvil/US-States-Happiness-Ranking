...
def train_model(X_train, y_train, out_dir):
    """Train Polynomial Regression using a pipeline and 5-Fold CV."""
    ...
    joblib.dump(search.best_estimator_, f"{out_dir}/PolyRegress_best.joblib")
    ...
    with open(f"{out_dir}/Polynomial_Regression_cv.json", "w") as f:
