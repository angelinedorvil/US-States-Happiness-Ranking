...
def train_model(X_train, y_train, out_dir):
    """Train Lasso Regression with 5-Fold CV."""
    ...
    joblib.dump(search.best_estimator_, f"{out_dir}/LassoRegress_best.joblib")
    ...
    with open(f"{out_dir}/Lasso_Regression_cv.json", "w") as f:
